...
MyTable.prototype.display = function () {
	...
	this.scene.translate(0,3.5 + (0.3*0.5),0); //3.5 da perna + metade da sua altura
	this.scene.scale(5,0.3,3); //muda o tamanho do cubo
	...
	this.scene.translate(-2.5 + (0.3*0.5),3.5*0.5,-1.5 + (0.3*0.5));
	this.scene.scale(0.3,3.5,0.3); //muda o tamanho do cubo
